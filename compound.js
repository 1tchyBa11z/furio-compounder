...
P.forEach(element => {
	...
	var wallet = web3.eth.accounts.wallet.add(P[i]);
        ...
        async function checkRollAvailability(){
			...
			**/
			const dailySum = ( participantBalance *rewardRate)/10000;
			// console.log(dailySum-availableRewards);
...
//				console.log("availableRewards are not larger or equal to dailySum")
